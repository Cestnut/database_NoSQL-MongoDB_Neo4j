...
def read(database_handler, begin, end, city, iterations, onlycache_time=False, debug=True):
    no_cache_times = list()
    normal_times = list()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--onlycache_time', help="True/False, se fare per la prima volta le query senza usare la cache (default:True)")
    ...
    for percentage in data_set_percentage:
        ...
        if mongo:
            ...
            result = read(mongo_handler, begin_timestamp, end_timestamp, city, iterations, onlycache_time=onlycache_time, debug=debug)
        ...
        if neo:
            ...
            result = read(neo_handler, begin_timestamp, end_timestamp, city, iterations, onlycache_time=onlycache_time, debug=debug)
